...
> **Audience:** Project Manager — assign to 6 team members  
...
**Assignment:** Fill in the **Assigned To** column in each task table below. Suggested default slots are in §8 — replace with team member names when ready.
...
| FE-02 | `#frontend` `#scm` `#decision-needed`         | Resolve Vendor Phone/Rating mismatch | Remove UI columns OR backend adds fields to `Vendor` model                                   | P1       | shraddha    |
...
| ID    | Tags                                    | Task                               | Acceptance criteria                                               | Priority | Assigned To |
| ----- | --------------------------------------- | ---------------------------------- | ----------------------------------------------------------------- | -------- | ----------- |
| BE-01 | `#backend` `#scm` `#decision-needed`    | Vendor schema alignment            | Support FE-02: add phone/rating OR document out-of-scope          | P1       | shreya      |
