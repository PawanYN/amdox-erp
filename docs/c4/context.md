...
- **C4 Container** (`docs/c4/container.md`) — zoom INTO the ERP box → shows web app, API, ML service, databases
- **C4 Component** (`docs/c4/component.md`) — zoom INTO one container (e.g. API) → shows modules like Finance, HR, SCM
