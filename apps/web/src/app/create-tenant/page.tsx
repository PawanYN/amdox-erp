      ...
      <div className="max-w-2xl mx-auto">
        ...
        {success ? (
          ...
          <form
            ...
            className="bg-white border border-[#E4E2DC] rounded-lg p-6 shadow-sm"
          >
            {error && (
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-[#4A4740] mb-1.5">
                  Company Name
                </label>
                <input
                  required
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  This will be used for the unique Keycloak Realm and Login URL.
                </p>
              </div>
